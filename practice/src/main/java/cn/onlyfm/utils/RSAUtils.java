...
public class RSAUtils {
	 ...
	 * @param content   待加密内容
	 * @param publicKey 公钥
	 * @param charset   content的字符集，如UTF-8, GBK, GB2312
	...
	public static String encryptByPublicKey(String content, PublicKey publicKey, String charset) {
		try {
			...
			byte[] data = (charset == null || StringUtils.isEmpty(charset)) ? content.getBytes() : content.getBytes(charset);
